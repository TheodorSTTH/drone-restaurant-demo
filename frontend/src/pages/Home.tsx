        ...
        <div className="flex-1">
                ...
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    {isAuthed ? (
                        ...
                        <div className="flex items-center gap-2">
                            <a href="/accounts/login/"><Button size={'sm'}>Log in</Button></a>
                            <a href="/accounts/signup/"><Button size={'sm'} variant="outline">Sign up</Button></a>
                        </div>
                    )}
                </div>
            </div>
            <div>
                ...
                <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
                    ...
                    <span className="">We do drone delivery<span className="text-primary">.</span></span>
                    </h1>
                    <div className="mt-5 max-w-4xl">
                    <p className="text-neutral-400 text-lg">
                    Delivery times will no longer lie at the mercy of busy roads. We deliver an end-to-end drone transportation service now live in Stockholm!
                    </p>
                    </div>
                </div>
                </div>
                ...
                <div className="relative z-10 pb-12">
                    ...
                    <div className="mb-4">
                        <h2 className="text-neutral-400">Completed 5 000+ flights, 40 000+ Kilometers covered, 4 440 kg Co2 saved and 124 km Longest flight</h2>
                    </div>
                    </div>
                </div>
                </div>
